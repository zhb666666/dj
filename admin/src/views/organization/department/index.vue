        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table ref="tableRef" class="mt-4" size="large" v-loading="loading" :data="lists" row-key="id"
                ...
                <el-table-column label="操作" width="160" fixed="right">
                    <template #default="{ row }">
                        <el-button v-perms="['system:dept:add']" type="primary" link @click="handleAdd(row.id)">
                            新增
                        </el-button>
                        <el-button v-perms="['system:dept:edit']" type="primary" link @click="handleEdit(row)">
                            编辑
                        </el-button>
                        <el-button v-if="row.pid !== 0" v-perms="['system:dept:del']" type="danger" link
