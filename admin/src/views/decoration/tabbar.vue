        ...
        <el-card shadow="never" class="!border-none flex-1" :body-style="{ height: '100%' }">
            <div class="flex h-full items-start">
                <div class="pages-preview mx-[30px]">
                    <div class="tabbar flex" style="background-color: #FB342A;">
                        <div class="tabbar-item flex flex-col justify-center items-center flex-1"
                            v-for="(item, index) in tabbar.list" :key="index"
                                            ...
                                            <del-wrap @close="handleDelete(index)" class="max-w-[400px]"
                                                ...
                                                <div class="bg-fill-light w-full p-4 mt-4">
                                                    <el-form-item label="导航图标">
                                                        <material-picker v-model="element.unselected"
                                                            upload-class="bg-body" size="60px">
                                                            <template #upload>
                                                        ...
                                                        <material-picker v-model="element.selected"
                                                            upload-class="bg-body" size="60px">
                                                            <template #upload>
                                                                <div class="upload-btn w-[60px] h-[60px]">
                                                                    <icon name="el-icon-Plus" :size="16" />
