...
import com.mdd.common.enums.IntegralEnum;
...
public class UserServiceImpl implements IUserService {
    ...
    public UserCenterVo center(Integer userId, Integer terminal) {
        User user = userMapper.selectOne(new QueryWrapper<User>()
                .select("id,sn,avatar,integral,real_name,nickname,username,mobile,money,is_new,password")
                .eq("id", userId)
                .last("limit 1"));
    ...
    public UserInfoVo info(Integer userId) {
        User user = userMapper.selectOne(new QueryWrapper<User>()
                .select("id,sn,avatar,integral,real_name,nickname,username,mobile,password,sex,create_time")
                .eq("id", userId)
                .last("limit 1"));
