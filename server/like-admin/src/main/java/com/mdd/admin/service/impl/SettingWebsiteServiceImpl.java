...
public class SettingWebsiteServiceImpl implements ISettingWebsiteService {
    ...
    public SettingWebsiteVo detail() {
        ...
        vo.setAnswerBackground(UrlUtils.toAbsoluteUrl(config.getOrDefault("answerBackground","")));
    ...
    public void save(SettingWebsiteValidate websiteValidate) {
        ...
        ConfigUtils.set("website","answerBackground",UrlUtils.toRelativeUrl(websiteValidate.getAnswerBackground()));
